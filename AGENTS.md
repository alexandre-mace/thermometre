...
Next.js 16 App Router, React 19, TypeScript strict, Tailwind CSS v4 (PostCSS, no `tailwind.config`). Static site: no backend, no route handlers. Conventions of the perso stack live in the shared repo `dev-standards`, file `next/next-guidelines.md`.
