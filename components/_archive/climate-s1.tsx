...
export function ClimateS1() {
  return (
    <section className="w-full bg-[#09090b] text-white font-[system-ui,sans-serif]">
      {/* ── GRID ── */}
      <div
        className="grid w-full border-b border-neutral-800 border-l border-r"
        style={{
      ...
      >
        {/* ROW 1 — HEADER */}
        <div
          className="border-b border-neutral-800 border-t px-6 py-8 md:px-10 md:py-10 flex flex-col md:flex-row md:items-end md:justify-between gap-4"
        ...
        >
          ...
          <div className="md:text-right">
            <p className="text-[10px] uppercase tracking-[0.3em] text-neutral-400 mb-1">
              Horizon
            </p>
        ...
        <div
          className="border-b border-neutral-800 border-r px-6 py-8 md:px-10 md:py-10 flex flex-col justify-between min-h-[260px] md:min-h-[320px]"
        ...
        >
          ...
          <div>
            <p
              className="text-6xl md:text-8xl lg:text-9xl font-bold leading-none tracking-tight mb-4"
              style={{ color: ACCENT_RED }}
            >
              80<span className="text-3xl md:text-5xl align-top">%</span>
            </p>
            <p className="text-sm md:text-base leading-snug max-w-[520px] text-neutral-300">
        ...
        <div
          className="border-b border-neutral-800 px-6 py-8 md:px-10 md:py-10 flex flex-col justify-between min-h-[260px]"
        ...
        <div
          className="border-b border-neutral-800 border-r px-6 py-8 md:px-10 md:py-10 flex flex-col justify-between min-h-[220px] md:min-h-[280px]"
        ...
        <div
          className="border-b border-neutral-800 px-6 py-8 md:px-10 md:py-10 flex flex-col justify-between min-h-[220px] md:min-h-[280px]"
        ...
        <div
          className="border-b border-neutral-800 border-r px-6 py-8 md:px-10 md:py-10 flex flex-col justify-between min-h-[220px]"
        ...
        >
          ...
          <div className="flex flex-col md:flex-row md:items-end gap-6 md:gap-10">
            ...
            <div className="border-t md:border-t-0 md:border-l border-neutral-800 pt-4 md:pt-0 md:pl-10">
              <p className="text-3xl md:text-5xl font-bold leading-none tracking-tight mb-1">
        ...
        <div
          className="border-b border-neutral-800 px-6 py-8 md:px-10 md:py-10 flex flex-col justify-between min-h-[220px]"
        ...
        {/* ROW 5 — FOOTER */}
        <div
          className="border-t border-neutral-800 px-6 py-6 md:px-10 md:py-8 flex flex-col md:flex-row md:items-center md:justify-between gap-3"
          style={{ gridColumn: "1 / -1" }}
        >
          <p className="text-xs md:text-sm leading-relaxed max-w-[800px] text-neutral-300">
